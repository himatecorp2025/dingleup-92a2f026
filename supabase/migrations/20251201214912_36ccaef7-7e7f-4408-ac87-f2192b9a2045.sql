-- Create function to generate full database export (CREATE TABLE + INSERT statements)
...
BEGIN
  ...
  LOOP
    ...
    FOR v_row_record IN EXECUTE 'SELECT * FROM public.' || quote_ident(v_table_record.tablename)
    LOOP
      ...
      LOOP
        ...
        -- Get value and quote it properly
