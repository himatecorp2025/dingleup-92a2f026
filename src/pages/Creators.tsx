...
import { ArrowLeft, Clock, Target, Rocket, Sparkles } from 'lucide-react';
...
const Creators = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[#1a0033] via-[#2d1b69] to-[#0f0033] flex flex-col overflow-y-auto">
      {/* Header */}
      <div className="flex-shrink-0 p-[clamp(0.75rem,2vh,1rem)] sticky top-0 z-10 bg-gradient-to-b from-[#1a0033]/90 to-transparent backdrop-blur-sm">
        <button
      ...
      {/* Main Content */}
      <div className="flex-1 px-4 pb-[calc(var(--bottom-nav-h,4rem)+2rem)] max-w-[440px] md:max-w-[800px] lg:max-w-[1040px] mx-auto w-full">
        
        {/* Hero Section */}
        <section className="relative mt-4 rounded-3xl overflow-hidden shadow-2xl">
          {/* Gradient Background */}
        ...
        {/* Closing Section */}
        <section className="mt-10 mb-6 text-center max-w-lg mx-auto">
