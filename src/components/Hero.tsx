      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16 space-y-4 sm:space-y-6 animate-fade-in px-4" style={{ animationDelay: '0.2s' }}>
            <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black mb-10 sm:mb-12 leading-tight sm:leading-snug md:leading-relaxed max-w-6xl mx-auto break-words hyphens-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-12 animate-fade-in px-4" style={{ animationDelay: '0.6s' }}>
            ...
            <Button
              onClick={() => navigate('/creators-landing')}
              variant="outline"
              size="lg"
            ...
            >
              <span className="truncate">{t('landing.hero.cta_creators')}</span>
            </Button>
          </div>
